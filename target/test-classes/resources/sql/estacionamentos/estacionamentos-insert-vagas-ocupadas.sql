...
insert into VAGAS (id, codigo, status) values (400, 'A-06', 'OCUPADA');
insert into VAGAS (id, codigo, status) values (500, 'A-07', 'OCUPADA');
...
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga) values ('20230315-101600', 'FIT-1020', 'FIAT', 'PALIO','VERDE', '2023-03-13 10:15:00', 21, 400);
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga) values ('20230315-101700', 'FIT-1020', 'FIAT', 'PALIO','VERDE', '2023-03-13 10:15:00', 22,5300);
